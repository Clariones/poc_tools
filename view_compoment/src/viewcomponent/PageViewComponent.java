...
public class PageViewComponent extends BaseViewComponent {
	...
	initialLayoutLevels.put(new HorizontalContainerViewComponent().getComponentType(), 0);
	initialLayoutLevels.put(new VerticalContainerViewComponent().getComponentType(), 0);
