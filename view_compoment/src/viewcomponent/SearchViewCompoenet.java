 ...
 * @author clariones
 */
public class SearchViewCompoenet extends BaseInputViewComponent {
    /**
    ...
    public SearchViewCompoenet(String placeHolder, String restUrl) {
	this(placeHolder, restUrl, null);
    }

    public SearchViewCompoenet(String placeHolder, String restUrl, String classes) {
	super();
