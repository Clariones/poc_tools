...
public class DataSourceUtil {
    ...
    public static DataSourceInfo parseExpression(Map<String, DataSourceInfo> globalVarTable,
	    DataSourceInfo parentDataSourceInfo, List<DataSourceInfo> localVarTable, String dataSourceExpression) throws Exception {
	if (dataSourceExpression == null || TextUtil.isBlank(dataSourceExpression)) {
	    throw new Exception("无任何内容的表达式");
	}
	dataSourceExpression = dataSourceExpression.trim();
	...
	switch (exprType) {
	case EXPRESSION_TYPE_MODEL_PATH:
	    return parseModelVariableExpression(globalVarTable, parentDataSourceInfo, localVarTable, dataSourceExpression, false);
	case EXPRESSION_TYPE_STRING_CONCAT_FUNCTION:
	    return parseStringConcatFunctionExpression(globalVarTable, parentDataSourceInfo, null,
    ...
    private static DataSourceInfo parseModelVariableExpression(Map<String, DataSourceInfo> vartable,
	    DataSourceInfo parentDataSourceInfo, List<DataSourceInfo> localVarTable, String dataSourceExpression, boolean isForGlobal) throws Exception {
